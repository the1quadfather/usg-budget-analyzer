...
| Fact | Value |
|---|---|
| Tables | `ai_cache`, `ai_spend`, `ai_user_history`, `funding_lines`, `pe_accomplishments`, `pe_congressional_actions`, `pe_narratives`, `program_elements`, `search_log`, `source_documents` |
| `program_elements` | 2,131 rows / **2,055 distinct** `pe_number` |
| `funding_lines` | 55,460 rows, **FY1996–FY2027** (README says FY1998 — wrong) |
| `funding_lines.funding_type` | only three values: `PY Actual` (20,692), `BY Request` (18,713), `CY Request` (16,055) |
